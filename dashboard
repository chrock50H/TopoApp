...
# Load CSV data
file_path = r"/Topo_App/data/Cross-border Physical Flows_202312312300-202412312300.csv"
...
#with col6:
#	st.image("/home/chris/Schreibtisch/01_scripts/data/50Hertz_2.png", use_container_width=True)
...
with col6:
	st.image("/Topo_App/data/50Hertz.png", use_container_width=True)
